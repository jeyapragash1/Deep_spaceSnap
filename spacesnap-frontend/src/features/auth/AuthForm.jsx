                ...
                {isLoginView ? (
                    ...
                    >
                        ...
                        <div className="text-right mt-2 mb-4">
                            <Link to="/forgot-password" className="text-sm text-primary-teal hover:underline">
                                Forgot Password?
                            </Link>
                        </div>
                        <button
                    ...
                    >
                        ...
                        <button
                            type="submit"
                            disabled={loading}
                            className="w-full bg-accent-gold text-white py-3 rounded-lg font-semibold hover:bg-opacity-90 transition-colors disabled:bg-gray-400"
                        >
