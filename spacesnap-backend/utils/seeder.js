...
const createSampleData = async() => {
    ...
    const users = [
      ...
      },
      {
        _id: new mongoose.Types.ObjectId(),
        name: "Anya Sharma",
        email: "anya.designer@spacesnap.com",
        password: hashedPassword,
        role: "designer",
        isEmailVerified: true,
        authMethod: "email",
      },
      {
        _id: new mongoose.Types.ObjectId(),
        name: "Leo Carter",
        email: "leo.designer@spacesnap.com",
        password: hashedPassword,
        role: "designer",
        isEmailVerified: true,
        authMethod: "email",
      ...
      },
      {
        ...
        email: "registered@spacesnap.com",
        password: hashedPassword,
        role: "registered",
        isEmailVerified: true,
        authMethod: "email",
...
const importData = async () => {
  try {
    ...
    const { users, designs, consultations } = await createSampleData();
